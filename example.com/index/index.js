...
myLib.Page.onLoaded = function () {
    ...
    (target => { /////////////////////////////////////////////////////////////////////////////////////////////////////////////// my_form ///
        let dialog = new myLib.Form.Button(target.inputs['dialog']);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        let error = new myLib.Form.Button(target.inputs['error']);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        let form = new myLib.Form.Button(target.inputs['form']);
        form.onTap = function () {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        let photo = new myLib.Form.Button(target.inputs['photo']);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        let pano = new myLib.Form.Button(target.inputs['pano']);
        pano.onTap = function () {
    ...
    })(new myLib.Form(this.forms['my_form']));
};