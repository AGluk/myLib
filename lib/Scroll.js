...
myLib.defineClass( ////////////////////////////////////////////////////////////////////////////////////////////////////////////// Scroll ///
    ...
    function Scroll(...args) {
        ...
        this.defineProperty('content', new myLib.Scroll.Content());
        this.target.appendChild(this.content.target);

        this.defineProperty('hscroll', new myLib.Scroll.Horizontal());
        this.target.appendChild(this.hscroll.target);

        this.defineProperty('vscroll', new myLib.Scroll.Vertical());
        this.target.appendChild(this.vscroll.target);
    ...
    myLib.Element.HTML.Div,
    {
        className: {
            ...
            get() {
                return this.target.className.match(/(^| )(scroll\s+(.+))?$/)[3] || '';
            },

            /** @this {myLib.Scroll.prototype} */
            set(className) {
                myLib.Element.HTML.Div.proto('className').set(this, `scroll ${className.trimStart()}`);
            }
        },
        ...
        appendChild(child) {
            ...
            this.content.target.appendChild(child.target);
        ...
        insertBefore(child, ref_child) {
            let index = this.content.children.indexOf(ref_child);
            if (index >= 0) {
                if (child.parent !== undefined)
                    child.parent.removeChild(child);

                this.content.target.insertBefore(child.target, ref_child.target);
                this.content.children.splice(index, 0, child);
                child.parent = this;
        ...
        /** @this {myLib.Scroll.prototype} */
        iterateDOM(callback, element = this.content.target) {
        ...
        removeChild(child) {
            ...
            if (index >= 0) {
                this.content.target.removeChild(child.target);
        ...
        replaceChild(child, ref_child) {
            ...
            if (index >= 0) {
                ...
                this.content.target.replaceChild(child.target, ref_child.target);
        ...
        resize() {
            this.onResize(true);
            this.content.onResize(true);

            for (const child of this.children)
                child.resize();

            this.content.onResize(false);
            this.hscroll.resize();
            this.vscroll.resize();
        ...
        scrollTo(left, top, zoom = 1, duration, callback) {
            ...
            if ((left !== this.scrollLeft) || (top !== this.scrollTop) || (zoom !== this.zoom)) {
                if (duration !== undefined) {
                    ...
                    this.zoom_.animate(zoom);
                    this.scrollLeft_.animate(left);
                    this.scrollTop_.animate(top);
...
myLib.Scroll.defineClass( ////////////////////////////////////////////////////////////////////////////////////////////////////// Content ///
    ...
    function Content() {
        myLib.Element.HTML.Div.call(this, 'content');
...
myLib.Scroll.defineClass( /////////////////////////////////////////////////////////////////////////////////////////////////// Horizontal ///
    ...
    function Horizontal() {
        myLib.Element.HTML.Div.call(this, 'hscroll');
...
myLib.Scroll.Horizontal.defineClass( /////////////////////////////////////////////////////////////////////////////////////////////// Bar ///
    ...
    function Bar() {
        myLib.Element.HTML.Div.call(this, 'bar');
...
myLib.Scroll.Horizontal.Bar.defineClass( ///////////////////////////////////////////////////////////////////////////////////////// Lever ///
    ...
    function Lever() {
        myLib.Element.HTML.Div.call(this, 'lever');
    },
...
myLib.Scroll.defineClass( ///////////////////////////////////////////////////////////////////////////////////////////////////// Vertical ///
    ...
    function Vertical() {
        myLib.Element.HTML.Div.call(this, 'vscroll');
