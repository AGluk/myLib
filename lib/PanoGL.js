    ...
    // Methods
    {
        ...
        setSrc(src, resolution) {
            ...
            for (let i = 0; i < 8; i++) {
                ...
                this.sources[i].onLoaded = () => {
                    ...
                    if (count === 0) {
                        ...
                        for (let i = 0; i < 8; i++) {
                            ...
                            myLib.AJAX.get(`getFilePath.php?src=${src}/${resolution}.nosync/${i}.jpg`, function (AJAX) {
                ...
                myLib.AJAX.get(`getFilePath.php?src=${src}/${resolution / 4}.nosync/${i}.jpg`, function (AJAX) {
                    this.src = AJAX.responseText;
                }.bind(this.sources[i]));
            }
