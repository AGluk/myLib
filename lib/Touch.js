...

{
    ...
    cover.className = 'my-touch-cover';
    ...
    document.addEventListener('mousedown', function (event) { //////////////////////////////////////////////////////////////////////////////
        ...
        if (event.object_list !== undefined) {
            ...
            object_list.top.target.focus(true);
            event.preventDefault();
            captured = true;
        } else {
            object_list = null;
        ...
        switch (capture) {
            case 1:
                ...
                if (object_list !== null) {
                    ...
                    } else if (event.gizmo.date - gizmo.date < 100) {
                        while (top !== null) {
                            top.target.touch.count = 0;
    ...
    myLib.defineClass( /////////////////////////////////////////////////////////////////////////////////////////////////////////// Touch ///
        /** @this {myLib.Touch & myLib.Element.HTML} */
        function Touch() {
            // Properties
            ...
            this.target.addEventListener('focusin', (/** @type {FocusEvent} */ event) => {
                this.onFocus(event.target) && event.stopPropagation();
            }, {
                capture: false,
                passive: true
            });
            ...
            this.target.addEventListener('focusout', (/** @type {FocusEvent} */ event) => {
                this.onBlur(event.target) && event.stopPropagation();
            }, {
                capture: false,
                passive: true
            });
